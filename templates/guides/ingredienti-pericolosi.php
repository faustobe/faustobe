...
<div class="guide-page">
  ...
  <nav class="guide-breadcrumb" aria-label="Breadcrumb">
    ...
    <span>›</span>
    <span><?= t('guides.ingredienti_breadcrumb') ?></span>
  </nav>
  ...
  <header class="guide-hero">
    <div class="guide-hero__text">
      ...
      <h1 class="guide-hero__title"><?= t('guides.ingredienti_h1') ?></h1>
      <p class="guide-hero__lead"><?= t('guides.ingredienti_lead') ?></p>
    ...
    <aside class="guide-hero__aside" aria-label="Indice della guida">
      ...
      <ol class="toc-list">
        <li><a href="#zuccheri-nascosti"><span class="toc-num">1</span><?= t('guides.ingredienti_toc_1') ?></a></li>
        <li><a href="#grassi-da-evitare"><span class="toc-num">2</span><?= t('guides.ingredienti_toc_2') ?></a></li>
        <li><a href="#additivi-controversi"><span class="toc-num">3</span><?= t('guides.ingredienti_toc_3') ?></a></li>
        <li><a href="#sodio-nascosto"><span class="toc-num">4</span><?= t('guides.ingredienti_toc_4') ?></a></li>
        <li><a href="#regola-del-5"><span class="toc-num">5</span><?= t('guides.ingredienti_toc_5') ?></a></li>
      </ol>
    </aside>
  </header>
...
<?php
$contentFile = __DIR__ . '/content/ingredienti-pericolosi.' . $currentLang . '.php';
require file_exists($contentFile)
    ? $contentFile
    : __DIR__ . '/content/ingredienti-pericolosi.it.php';
?>
  </div><!-- /guide-content -->
</div><!-- /guide-page -->
</main>
