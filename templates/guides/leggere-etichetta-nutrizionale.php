...
<div class="guide-page">
  ...
  <nav class="guide-breadcrumb" aria-label="Breadcrumb">
    ...
    <span>›</span>
    <span><?= t('guides.leggere_etichetta_breadcrumb') ?></span>
  </nav>
  ...
  <header class="guide-hero">
    <div class="guide-hero__text">
      <div class="guide-hero__tag">
        <span>🏷️</span> <?= t('guides.category_info') ?>
      </div>
      <h1 class="guide-hero__title"><?= t('guides.leggere_etichetta_h1') ?></h1>
      <p class="guide-hero__lead"><?= t('guides.leggere_etichetta_lead') ?></p>
    ...
    <aside class="guide-hero__aside" aria-label="Indice della guida">
      ...
      <ol class="toc-list">
        <li><a href="#ingredienti"><span class="toc-num">1</span><?= t('guides.leggere_etichetta_toc_1') ?></a></li>
        <li><a href="#tabella-nutrizionale"><span class="toc-num">2</span><?= t('guides.leggere_etichetta_toc_2') ?></a></li>
        <li><a href="#porzioni"><span class="toc-num">3</span><?= t('guides.leggere_etichetta_toc_3') ?></a></li>
        <li><a href="#sale-nascosto"><span class="toc-num">4</span><?= t('guides.leggere_etichetta_toc_4') ?></a></li>
        <li><a href="#claim"><span class="toc-num">5</span><?= t('guides.leggere_etichetta_toc_5') ?></a></li>
        <li><a href="#checklist"><span class="toc-num">6</span><?= t('guides.leggere_etichetta_toc_6') ?></a></li>
      </ol>
    </aside>
  </header>
...
<?php
$contentFile = __DIR__ . '/content/leggere-etichetta-nutrizionale.' . $currentLang . '.php';
require file_exists($contentFile)
    ? $contentFile
    : __DIR__ . '/content/leggere-etichetta-nutrizionale.it.php';
?>
  </div><!-- /guide-content -->
</div><!-- /guide-page -->
</main>
