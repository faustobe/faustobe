...
<div class="guide-page">
  ...
  <nav class="guide-breadcrumb" aria-label="Breadcrumb">
    ...
    <span>›</span>
    <span><?= t('guides.additivi_ultra_breadcrumb') ?></span>
  </nav>
  ...
  <header class="guide-hero">
    <div class="guide-hero__text">
      ...
      <h1 class="guide-hero__title"><?= t('guides.additivi_ultra_h1') ?></h1>
      <p class="guide-hero__lead"><?= t('guides.additivi_ultra_lead') ?></p>
    ...
    <aside class="guide-hero__aside" aria-label="Indice della guida">
      ...
      <ol class="toc-list">
        <li><a href="#cosa-sono-additivi"><span class="toc-num">1</span><?= t('guides.additivi_ultra_toc_1') ?></a></li>
        <li><a href="#cosa-sono-ultraprocessati"><span class="toc-num">2</span><?= t('guides.additivi_ultra_toc_2') ?></a></li>
        <li><a href="#quando-coincidono"><span class="toc-num">3</span><?= t('guides.additivi_ultra_toc_3') ?></a></li>
        <li><a href="#doppio-problema"><span class="toc-num">4</span><?= t('guides.additivi_ultra_toc_4') ?></a></li>
        <li><a href="#come-riconoscerli"><span class="toc-num">5</span><?= t('guides.additivi_ultra_toc_5') ?></a></li>
      </ol>
    </aside>
  </header>
...
<?php
$contentFile = __DIR__ . '/content/additivi-vs-ultraprocessati.' . $currentLang . '.php';
require file_exists($contentFile)
    ? $contentFile
    : __DIR__ . '/content/additivi-vs-ultraprocessati.it.php';
?>
  </div><!-- /guide-content -->
</div><!-- /guide-page -->
</main>
