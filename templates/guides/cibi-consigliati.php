...
<div class="guide-page">
  ...
  <nav class="guide-breadcrumb" aria-label="Breadcrumb">
    ...
    <span>›</span>
    <span><?= t('guides.cibi_breadcrumb') ?></span>
  </nav>
  ...
  <header class="guide-hero">
    <div class="guide-hero__text">
      ...
      <h1 class="guide-hero__title"><?= t('guides.cibi_h1') ?></h1>
      <p class="guide-hero__lead"><?= t('guides.cibi_lead') ?></p>
    ...
    <aside class="guide-hero__aside" aria-label="Indice della guida">
      ...
      <ol class="toc-list">
        <li><a href="#principio-base"><span class="toc-num">1</span><?= t('guides.cibi_toc_1') ?></a></li>
        <li><a href="#cereali"><span class="toc-num">2</span><?= t('guides.cibi_toc_2') ?></a></li>
        <li><a href="#proteine"><span class="toc-num">3</span><?= t('guides.cibi_toc_3') ?></a></li>
        <li><a href="#grassi-buoni"><span class="toc-num">4</span><?= t('guides.cibi_toc_4') ?></a></li>
        <li><a href="#spuntini"><span class="toc-num">5</span><?= t('guides.cibi_toc_5') ?></a></li>
        <li><a href="#lista-spesa"><span class="toc-num">6</span><?= t('guides.cibi_toc_6') ?></a></li>
      </ol>
    </aside>
  </header>
...
<?php
$contentFile = __DIR__ . '/content/cibi-consigliati.' . $currentLang . '.php';
require file_exists($contentFile)
    ? $contentFile
    : __DIR__ . '/content/cibi-consigliati.it.php';
?>
  </div><!-- /guide-content -->
</div><!-- /guide-page -->
</main>
