...
<div class="guide-page">
  ...
  <nav class="guide-breadcrumb" aria-label="Breadcrumb">
    ...
    <span>›</span>
    <span><?= t('guides.nova_breadcrumb') ?></span>
  </nav>
  ...
  <header class="guide-hero">
    <div class="guide-hero__text">
      ...
      <h1 class="guide-hero__title"><?= t('guides.nova_h1') ?></h1>
      <p class="guide-hero__lead"><?= t('guides.nova_lead') ?></p>
    ...
    <aside class="guide-hero__aside" aria-label="Indice della guida">
      ...
      <ol class="toc-list">
        <li><a href="#cosa-e-nova"><span class="toc-num">1</span><?= t('guides.nova_toc_1') ?></a></li>
        <li><a href="#gruppo-1"><span class="toc-num">2</span><?= t('guides.nova_toc_2') ?></a></li>
        <li><a href="#gruppo-2"><span class="toc-num">3</span><?= t('guides.nova_toc_3') ?></a></li>
        <li><a href="#gruppo-3"><span class="toc-num">4</span><?= t('guides.nova_toc_4') ?></a></li>
        <li><a href="#gruppo-4"><span class="toc-num">5</span><?= t('guides.nova_toc_5') ?></a></li>
        <li><a href="#nova-in-pratica"><span class="toc-num">6</span><?= t('guides.nova_toc_6') ?></a></li>
      </ol>
    </aside>
  </header>
...
<?php
$contentFile = __DIR__ . '/content/classificazione-nova.' . $currentLang . '.php';
require file_exists($contentFile)
    ? $contentFile
    : __DIR__ . '/content/classificazione-nova.it.php';
?>
  </div><!-- /guide-content -->
</div><!-- /guide-page -->
</main>
